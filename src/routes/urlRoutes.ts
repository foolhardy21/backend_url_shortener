...
import { apiKeyValidator, logger } from "../middlewares/common"
...
router.post("/bulk-shorten", logger, apiKeyValidator, fileUpload.single("urlsCsv"), validators.validateBulkShortenPayload, urlController.createBulkShortUrls)
